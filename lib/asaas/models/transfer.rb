module Asaas
  class Transfer < Model
    ...
    attribute :transferFee, Types::JSON::Decimal.optional.default(nil)
    ...
    attribute :bankAccount, Types::JSON::Hash.optional.default(nil)
    attribute :type, AccountType.optional.default(nil)
    attribute :walletId, Types::Coercible::String.optional.default(nil)
    attribute :account, Types::JSON::Hash.optional.default(nil)
  end
end
